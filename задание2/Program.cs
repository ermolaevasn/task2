...
namespace задание2
{
    class Program
    {
        ...
        {
            Console.WriteLine(@"Имеется бесконечная вправо и вверх шахматная доска, на которой стоит ферзь. 
Двое по очереди двигают этого ферзя. Требуется найти номер игрока, который выиграет при правильной игре");
